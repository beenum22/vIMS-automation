...
def del_networks(neutron, configurations, error_logger, logger_neutron):
	...
	clear_network(configurations['networks']['s1c-name'], neutron, configurations, error_logger, logger_neutron)
	
	remove_interface(neutron, get_subnet_id(neutron, configurations['networks']['s1u-name']), router_id)
	clear_network(configurations['networks']['s1u-name'], neutron, configurations, error_logger, logger_neutron)
	
	remove_interface(neutron, get_subnet_id(neutron, configurations['networks']['sgs-name']), router_id)
	clear_network(configurations['networks']['sgs-name'], neutron, configurations, error_logger, logger_neutron)
	
	remove_interface(neutron, get_subnet_id(neutron, configurations['networks']['sgi-name']), router_id)
	clear_network(configurations['networks']['sgi-name'], neutron, configurations, error_logger, logger_neutron)
