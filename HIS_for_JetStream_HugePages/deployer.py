...
#from settings import extract_inventory
...
def deploy():
    ...
    try:
        ...
        parser.add_argument('-skip_rhscon_vm', '--skip_rhscon_vm',
                            ...
                            action='store_true',
                            required=False)
        parser.add_argument('-j', '--jetstream',
                            help='ini recommended requirement file, e.g settings/Jet_Stream.ini',
                            required=True)
        args, ignore = parser.parse_known_args()
        ...
        settings = Settings(args.settings,args.jetstream)
        ...
        director_vm.enable_NUMA()
        director_vm.enable_hugepages() 
