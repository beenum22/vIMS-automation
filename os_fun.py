...
def del_agg(nova):
	...
	try:
		...
		print("Successfully deleted aggregate group A ")
	except:
		print("Unable to Delete Aggregate group A")
		pass
	try:
		nova.aggregates.remove_host(a_id[1].id, hostnB)
		nova.aggregates.delete(a_id[1].id)
		print("Successfully deleted aggregate group B ")
	except:
		print("Unable to Delete Aggregate group B")
		pass
	print("Successfully deleted aggregate groups ")